...
def define_experiment(exp_dict, args):
    ...
    set_dir_run     ( exp_dict, os.getcwd() + '/bin_vs_time' )        ## working directory where your program should be executed
    set_dir_data    ( exp_dict, os.getcwd() + '/data_vs_time' )       ## directory for data files produced by individual runs of your program
