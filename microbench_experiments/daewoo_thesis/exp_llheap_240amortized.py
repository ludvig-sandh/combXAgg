...
def define_experiment(exp_dict, args):
    ...
    set_dir_run     ( exp_dict, os.getcwd() + '/bin_llheap_240amortized' )    ## working directory where your program should be executed
    ...
    add_run_param     ( exp_dict, 'alloc'           , ['super0', 'super1', 'super2', 'super3', 'super4', 'jemalloc', 'tcmalloc', 'hoard', 'mimalloc', 'glibc', 'llheap'] )
