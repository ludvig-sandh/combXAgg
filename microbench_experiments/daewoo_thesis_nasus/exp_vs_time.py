...
def define_experiment(exp_dict, args):
    ...
    set_dir_run     ( exp_dict, os.getcwd() + '/bin_time_axis' )      ## working directory where your program should be executed
    set_dir_data    ( exp_dict, os.getcwd() + '/data_time_axis' )     ## directory for data files produced by individual runs of your program
    ...
    add_run_param     ( exp_dict, 'alloc'           , ['super0', 'super1', 'super2', 'super3', 'super4', 'jemalloc', 'tcmalloc', 'hoard', 'mimalloc', 'glibc'] )
    ...
    filters = [
      ...
      'alloc in ("super0", "super3", "jemalloc", "tcmalloc", "glibc")',
      'alloc in ("super0", "super3", "jemalloc", "tcmalloc", "hoard", "mimalloc", "glibc")'
    ]
