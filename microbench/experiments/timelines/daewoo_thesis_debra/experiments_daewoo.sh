...
for free in immediate amortized ; do
    ...
    for allocator in llheap ; do #jemalloc tcmalloc mimalloc hoard ; do #supermalloc ; do
        for threads in 192 ; do #240 96 48 ; do
            for numactl in none interleave ; do
                for pinning in no yes ; do
