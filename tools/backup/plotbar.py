...
if _title == '':
    df.plot.bar(x='labels', y='values', figsize=(args.width_inches, args.height_inches))
else:
    df.plot.bar(x='labels', y='values', title=_title, figsize=(args.width_inches, args.height_inches))
