...
h, xedges, yedges, im = plt.hist2d(datax, datay, weights=dataw, bins=np.arange(args.numBins+1)-0.5, norm=(mpl.colors.LogNorm() if args.useLogscale else mpl.colors.Normalize()), cmap='hot')
