...
# Algorithms to test
algorithms=(
  stacks_bsf_1_metadata
  stacks_bsf_2_metadata
  stacks_bsf_3_metadata
  stacks_bsf_4_metadata
  stacks_bsf_5_metadata
  stacks_ouropt_bsf_1_metadata
  stacks_ouropt_bsf_2_metadata
  stacks_ouropt_bsf_3_metadata
  stacks_ouropt_bsf_4_metadata
  stacks_ouropt_bsf_5_metadata
)
...
for config in "${configs[@]}"; do
    ...
    output_file="all_paper_metadata_titan_${ip}_${dp}.csv"
    rm -f "$output_file"
    ...
    for n in "${threads[@]}"; do
        ...
        for alg in "${algorithms[@]}"; do
            ...
            for ((trial=0; trial<trials; ++trial)); do
                ...
                sfname="step_metadata_titan_${alg}_${ip}_${dp}_${n}_${trial}.txt"
                if [ "$n" -gt 192 ]; then
                    ...
                    -pin 0-11,48-59,12-23,60-71,24-35,72-83,36-47,84-95,96-107,108-119,120-131,132-143,144-155,156-167,168-179,180-191 -prefillsize 1000 \
                    > "$sfname"
                fi
