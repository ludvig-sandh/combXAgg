...
/// @brief Define DEBUG_FC_STACK, in case you want to debug some parts of the code or to get some  useful performance statistics.
...
#define SYNCH_NUMA_SUPPORT  //#FIXME: By commenting this out we may have messed up with performance of CCSYNCH??
